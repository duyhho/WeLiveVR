...
public class Lite6Head : MonoBehaviour
{
    ...
    private IEnumerator CallEveryXSeconds(int numSeconds) {
        while (true) {
            ...
            Vector3 coor = new Vector3(headDevice.localPosition.y * 200f, headDevice.localPosition.x * -270f, -headDevice.localPosition.z * 280f); 
            ...
            */
            ...
            Vector3 eulerAngles = headDevice.eulerAngles - new Vector3(0f, 100f, 270f);
            // Vector3 eulerAngles = headDevice.eulerAngles - new Vector3(0f, 100f, 270f);
