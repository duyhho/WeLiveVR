...
namespace Wolf3D.ReadyPlayerMe.AvatarSDK
{
    ...
    [AddComponentMenu("Ready Player Me/Eye Animation Handler Custom", 0)]
    public class EyeAnimationHandlerCustom : MonoBehaviour
    {
        ...
        private const string HalfbodyLeftEyeBoneName = "Hips/Spine/Neck/Head/LeftEye";
        private const string FullbodyLeftEyeBoneName = "Armature/Hips/Spine/Spine1/Spine2/Neck/Head/LeftEye";

        private Transform rightEyeBone;
        private const string HalfbodyRightEyeBoneName = "Hips/Spine/Neck/Head/RightEye";
