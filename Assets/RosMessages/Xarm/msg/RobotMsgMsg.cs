...
namespace RosMessageTypes.Xarm
{
    ...
    public class RobotMsgMsg : Message
    {
        ...
        public RobotMsgMsg(HeaderMsg header, short state, short mode, short cmdnum, short mt_brake, short mt_able, short err, short warn, float[] angle, float[] pose, float[] offset)
        {
            this.header = header;
            this.state = state;
            this.mode = mode;
