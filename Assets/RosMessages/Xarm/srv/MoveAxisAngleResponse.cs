...
{
    [Serializable]
    public class MoveAxisAngleResponse : Message
    {
        ...
        public MoveAxisAngleResponse()
        {
            this.ret = 0;
            this.message = "";
        }

        public MoveAxisAngleResponse(short ret, string message)
        {
            this.ret = ret;
            this.message = message;
        }

        public static MoveAxisAngleResponse Deserialize(MessageDeserializer deserializer) => new MoveAxisAngleResponse(deserializer);

        private MoveAxisAngleResponse(MessageDeserializer deserializer)
        {
